...
class Splash < Formula
  ...
  url "https://github.com/danieljprice/splash/releases/download/v3.1.1/splash-v3.1.1.tar.gz"
  version "3.1.1"
  sha256 "52113bdc053ea3946bd8d4af087f04ad81dc3224194ac1471e105008eb46f812"
  depends_on "gcc"
  depends_on "giza-x11"
  depends_on "hdf5"
  depends_on "cfitsio"
