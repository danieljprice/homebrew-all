...
class Splash < Formula
  ...
  url "https://github.com/danieljprice/splash/releases/download/v3.1.0/splash-v3.1.0.tar.gz"
  version "3.1.0"
  sha256 "3e59be022a4f149332371ec299b68a7cd46044d9ba1b13c70976fa8a2ae42589"
  depends_on "gcc"
  depends_on "giza-x11"
  depends_on "hdf5"
  depends_on "cfitsio"
