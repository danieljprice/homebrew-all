...
class Splash < Formula
  ...
  url "https://github.com/danieljprice/splash/releases/download/v3.3.1/splash-v3.3.1.tar.gz"
  version "3.3.1"
  sha256 "24b1e91d5402f7ef7f3394896dfbbd01da5fb21d8dab25e2389563b8a045d3c7"
  depends_on "gcc"
  depends_on "giza-x11"
  depends_on "hdf5"
  depends_on "cfitsio"
